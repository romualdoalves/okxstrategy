...
class VianaMiniIndiceStrategy(BaseStrategy):
    ...
    def info(cls) -> StrategyInfo:
        return StrategyInfo(
            ...
            criteria=[
                {"id": "c1_session", "label": "C1 Sessão", "description": "Janela operacional da sessão está ativa."},
                {"id": "c2_range", "label": "C2 Range", "description": "Range inicial definido e válido."},
                {"id": "c3_breakout", "label": "C3 Rompimento", "description": "Preço rompe região operacional."},
                {"id": "c4_vwap", "label": "C4 VWAP", "description": "VWAP confirma direção."},
                {"id": "c5_players", "label": "C5 Players", "description": "Dados de players/posicionamento confirmam contexto."},
